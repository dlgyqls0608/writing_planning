...
작가의 아이디어를 바탕으로 스토리 바이블 전체 개요를 작성하세요.
...
작가의 아이디어를 바탕으로 세계관·배경 설정집을 상세하게 작성하세요.
...
(이 세계가 현실과 다른 가장 중요한 규칙 3~5가지를 번호로 서술)
...
**시각적 레퍼런스**: (독자가 떠올릴 수 있는 유사 작품 또는 이미지 키워드)
**세계의 감정 온도**: (차갑고 냉정한 / 활기차고 역동적인 / 어둡고 무거운 등)

---

## 작가 메모 — 세계관 금기

(이 세계관에서 절대 어겨서는 안 되는 설정 규칙)`,
...
작가가 입력한 인물 정보를 바탕으로 캐릭터 카드를 상세하게 작성하세요.
